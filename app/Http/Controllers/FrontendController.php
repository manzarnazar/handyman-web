...
class FrontendController extends Controller
{
    ...
    public function bookServiceView(Request $request)
    {
        ...
        // return view('landing-page.BookService', compact('service', 'shop_list', 'shop_id', 'coupons', 'taxes', 'user_id', 'availableserviceslot', 'serviceaddon', 'googlemapkey', 'wallet_amount'));

        // Pass both to the view
        return view('landing-page.BookService', compact(
            'service', 'shop_list', 'shop_id', 'coupons', 'taxes', 'user_id', 'availableserviceslot', 'serviceaddon', 'googlemapkey', 'wallet_amount', 'wallet_enabled'
        ));
    }
