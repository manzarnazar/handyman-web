      ...
      let datatableObj = {
        ...
        initComplete: function () {
          ...
          lengthMenuContainer.append(
            `<span class="ms-2 text-muted custom-length-info">Showing 1 to ${pageInfo.end} of ${totalEntries} entries</span>`
          )
        ...
        drawCallback: function () {
          ...
          if (lengthInfoSpan.length) {
            lengthInfoSpan.text(
              `Showing ${pageInfo.start + 1} to ${pageInfo.end} of ${totalEntries} entries`
            )
          }
        }
      }
