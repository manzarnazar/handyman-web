            ...
            <div class="col-lg-12">
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        {{-- <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            @if ($auth_user->can('service add') && Route::currentRouteName() !== 'servicepackage.service')
                                <a href="{{ route('service.create') }}" class="float-end me-1 btn btn-sm btn-primary "><i
                                    ...
                                    {{ __('messages.add_form_title', ['form' => __('messages.service')]) }}
                                </a>
                            @endif

                            @if($auth_user->can('servicepackage list') && request()->is('servicepackage/list/*'))
                            <h5>Package service list</h5>
                                <a href="{{ route('servicepackage.index') }}" class="float-end btn btn-sm btn-primary">
                        ...
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            @if(!request()->is('servicepackage/list/*')) <!-- Check if not on 'servicepackage/list/*' -->
                                <h5 class="fw-bold">{{ $pageTitle ?? trans('messages.list') }}</h5>
                            @endif

                            @if ($auth_user->can('service add') && Route::currentRouteName() !== 'servicepackage.service')
                                <a href="{{ route('service.create') }}" class="float-end me-1 btn btn-sm btn-primary">
                            ...
                            @if($auth_user->can('servicepackage list') && request()->is('servicepackage/list/*'))
                                <h5>{{ __('messages.packages_service_list') }}</h5> <!-- Show custom heading when on the route -->
                                <a href="{{ route('servicepackage.index') }}" class="float-end btn btn-sm btn-primary">
                                    <i class="fa fa-angle-double-left"></i> {{ __('messages.back') }}
                                </a>
                            @endif
