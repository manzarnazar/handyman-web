...
@section('content')
    <div class="section-padding">
        <div class="container">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <p class="m-0 text-success text-capitalize">
                                        {{ $bookingData['booking_detail']['status_label'] }}</p>
                                    @if ($bookingData['booking_detail']['status'] === 'cancelled' && !empty($bookingData['booking_detail']['reason']))
                                        <p class="m-0 text-muted small mt-1 text-wrap text-break">
                                            <strong>{{ __('landingpage.cancel_reason') }}:</strong>
                                            {{ $bookingData['booking_detail']['reason'] }}
                                        </p>
                                    @endif
                                    <a href="javascript:void(0);"
                                        class="d-inline-block letter-spacing-1 text-capitalize text-decoration-underline h6 text-primary"
                                        data-bs-toggle="modal"
                                        data-bs-target="#statusModal">{{ __('landingpage.check_status') }}</a>
                                </div>

                                @if ($bookingData['booking_detail']['booking_package'] == null)
                                    <h5 class="mt-2 mb-2 text-capitalize">#{{ $bookingData['booking_detail']['id'] }} <a
                                            href="{{ route('service.detail', $bookingData['booking_detail']['service_id']) }}">
                                            {{ $bookingData['booking_detail']['service_name'] }}</a></h5>
                                @else
                                    <h5 class="mt-2 mb-2 text-capitalize">#{{ $bookingData['booking_detail']['id'] }}
                                        {{ $bookingData['booking_detail']['booking_package']['name'] }}</h5>
                                @endif
                                <p class="mb-2 text-capitalize font-size-18 fw-500">
                                        ...
                                        <span class="text-primary">
                                            ...
                                            @if (!empty($bookingData['booking_detail']['duration_diff_hour']))
                                                @php
                                                    ...
                                                    $durationParts = $bookingData['booking_detail'][
                                                        'duration_diff_hour'
                                                    ]
                                                        ? $bookingData['booking_detail']['duration_diff_hour']
                                                        : null;
                                                @endphp
                                ...
                                <div>
                                    <input type="hidden" id="booking_id" name="id"
                                        value="{{ $bookingData['booking_detail']['id'] }}">

                                    @if (
                                        $bookingData['booking_detail']['status'] === 'pending' &&
                                    ...
                                    @if (
                                        $bookingData['booking_detail']['status'] === 'completed' &&
                                            ($bookingData['booking_detail']['payment_status'] === null ||
                                                $bookingData['booking_detail']['payment_status'] === 'failed' ||
                                                $bookingData['booking_detail']['payment_status'] === 'advanced_paid') &&
                                            $bookingData['booking_detail']['total_amount'] != 0)
                                        ...
                                        <div class="mt-5">
                                            @php
                                                $remainingPrice =
                                                    $bookingData['booking_detail']['total_amount'] -
                                                    ($bookingData['booking_detail']['advance_paid_amount'] ?? 0);
                                                ...
                                                $payablePrice =
                                                    $remainingPrice > 0
                                                        ...
                                                        : $bookingData['booking_detail']['total_amount'];
                                            @endphp
                                            <a onclick="togglePayment()" id="pay_advance"
                                                class="btn btn-primary text-capitalize">{{ __('landingpage.pay_now') }}
                                                ({{ getPriceFormat($payablePrice) }})</a>
                                        </div>
                                    @endif

                                    @if ($bookingData['booking_detail']['status'] === 'on_going')
                                        <div class="mt-5">
                                            <button type="button" id="startBooking" onclick="startBooking()"
                                                class="btn btn-success text-capitalize">{{ __('landingpage.start') }}</button>
                                            <div class="d-block mt-3">
                                                <span class="text-primary bg-light">{{ __('messages.on_going') }}</span>
                                            </div>
                                        </div>
                                    @elseif(isset($bookingData['shop_data']) && !empty($bookingData['shop_data']))
                                        @if (isset($bookingData['handyman_data']) && !empty($bookingData['handyman_data']))
                                            @if ($bookingData['booking_detail']['status'] === 'accept')
                                                <button type="button" id="startBooking" onclick="startBooking()"
                                                    class="btn btn-success text-capitalize mt-3">{{ __('landingpage.start') }}</button>
                                            @endif
                                        @endif
                                    @endif
                                    @if ($bookingData['booking_detail']['status'] === 'in_progress')
                                        <input type="hidden" id="start_at"
                                            value="{{ $bookingData['booking_detail']['start_at'] }}">
                                        <input type="hidden" id="duration_diff"
                                            value="{{ $bookingData['booking_detail']['duration_diff'] }}">
                                        <div class="d-flex align-items-center mt-5 flex-wrap gap-3">
                                            @if ($bookingData['service']['type'] !== 'fixed')
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#reasonModal"
                                                    class="btn btn-warning text-capitalize">{{ __('landingpage.hold') }}</button>
                                            @endif
                                            <button type="button" onclick="doneBooking()"
                                                class="btn btn-primary text-capitalize">{{ __('landingpage.done') }}</button>
                                        </div>
                                    @endif
                                    ...
                                    @if ($bookingData['booking_detail']['status'] === 'hold')
                                        <input type="hidden" id="duration_diff"
                                            value="{{ $bookingData['booking_detail']['duration_diff'] }}">
                                        <div class="d-flex align-items-center mt-5 flex-wrap gap-3">
                                            <button type="button" onclick="resumeBooking()"
                                                class="btn btn-primary text-capitalize">{{ __('landingpage.resume') }}</button>
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#cancelModal"
                                                class="btn btn-danger text-capitalize">{{ __('landingpage.cancel') }}</button>
                                        </div>
                                    @endif
                                    ...
                                    @if ($bookingData['booking_detail']['status'] === 'pending_approval')
                                        <div class="d-block mt-5">
                                            <span
                                                class="text-dark bg-light">{{ __('landingpage.waiting_for_response') }}...</span>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="col-md-4 text-md-end mt-5 mt-md-0">
                                @php
                                    ...
                                    if ($bookingData['booking_detail']['booking_package'] == null) {
                                        ...
                                        $imageSource = !empty(
                                            $bookingData['booking_detail']['booking_package']['attchments']
                                        )
                                            ? $bookingData['booking_detail']['booking_package']['attchments'][0]
                                            : null;
                                    }
                                @endphp
                                <img src="{{ $imageSource ?? asset('images/default.png') }}" width="357" height="253"
                                    class="mw-100 rounded-3 object-cover" alt="service-detail">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 py-5 position-relative pe-xl-5">
                            ...
                            @php
                                ...
                                $services =
                                    isset($servicepackage['services']) && is_array($servicepackage['services'])
                            ...
                            @foreach ($services as $service)
                                @php
                                    ...
                                    $service_image = isset($service['attchments'][0])
            ...
            @endif
            @if (isset($bookingData['shop_data']) && !empty($bookingData['shop_data']))
                <h6 class="mt-4 font-size-18 text-capitalize">{{ __('landingpage.about_shop') }}</h6>
                <div class="row pt-4 align-items-center gy-4">
                    <div class="col-12 col-md-3">
                        <a href="{{ route('shop.detail', $bookingData['shop_data']['id']) }}">
                            <div class="shop-image-container" style="overflow: hidden; height: 230px;">
                                <img src="{{ $bookingData['shop_data']['shop_image'][0] ?? asset('images/default.png') }}"
                                    class="img-fluid rounded-3 booking-img" style="width: 300px; height: 450px;"
                                    alt="{{ $bookingData['shop_data']['name'] }}" loading="lazy">
                            </div>
                        </a>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start mb-3">
                            <a href="{{ route('shop.detail', $bookingData['shop_data']['id']) }}">
                                <h4 class="mb-2 mb-md-0">{{ $bookingData['shop_data']['name'] }}</h4>
                            </a>
                        </div>
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                <div class="bg-light p-3 rounded h-100">
                                    <p class="mb-0"><i
                                            class="fas fa-phone me-2 text-primary"></i>{{ $bookingData['shop_data']['contact_number'] }}
                                    </p>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="bg-light p-3 rounded h-100">
                                    <p class="mb-0 text-break"><i
                                            class="fas fa-envelope me-2 text-primary"></i>{{ $bookingData['shop_data']['email'] }}
                                    </p>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="bg-light p-3 rounded h-100">
                                    <p class="mb-0">
                                        ...
                                        {{ \Carbon\Carbon::parse($bookingData['shop_data']['shop_start_time'])->format('g:i A') }}
                                        -
                                        {{ \Carbon\Carbon::parse($bookingData['shop_data']['shop_end_time'])->format('g:i A') }}
                                    </p>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="bg-light p-3 rounded h-100">
                                    <p class="mb-0"><i
                                            class="fas fa-map-marker-alt me-2 text-primary"></i>{{ $bookingData['shop_data']['address'] }},
                                        {{ $bookingData['shop_data']['city_name'] }},
                                        {{ $bookingData['shop_data']['state_name'] }},
                                        {{ $bookingData['shop_data']['country_name'] }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @if ($bookingData['booking_detail']['BookingAddonService'])
                <div class="my-lg-5 my-3">
                    <div class="row">
                        <div class="col-lg-6 py-5 position-relative pe-xl-5">
                            <h4 class="mt-0 mb-4 font-size-18 text-capitalize">{{ __('landingpage.Add-ons') }}</h4>
                            @foreach ($bookingData['booking_detail']['BookingAddonService'] as $serviceaddon)
                                <div
                                    class="mb-4 pb-4 border-bottom d-flex align-items-sm-center aling-items-start flex-sm-row flex-column gap-5">
                                    <div class="flex-shrink-0 provider-image-container">
                                        <img src="{{ $serviceaddon['serviceaddon_image'] ? asset($serviceaddon['serviceaddon_image']) : asset('images/default.png') }}"
                                            alt="service-image" class="img-fluid object-fit-cover rounded-3"
                                            style="width: 100px; height:100px;">
                                    </div>
                                    <div>
            ...
            <div class="py-lg-5 my-lg-5 py-3 my-3">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-sm-6 position-relative">
                                <h6 class="mt-0 mb-4 font-size-18 text-capitalize">
                                    ...
                                    @if (isset($bookingData['handyman_data']) &&
                                            count($bookingData['handyman_data']) > 0 &&
                                            $bookingData['provider_data']['id'] === $bookingData['handyman_data'][0]['id']
                                    )
                                ...
                                <div class="img flex-shrink-0 mb-4">
                                    <a href="{{ route('provider.detail', $bookingData['provider_data']['id']) }}">
                                        <img src="{{ $bookingData['provider_data']['profile_image'] ? asset($bookingData['provider_data']['profile_image']) : asset('images/user/user.png') }}"
                                            width="208" height="208" class="mw-100 rounded-3 object-cover"
                                            alt="about-provider">
                                    </a>
                                </div>
                                <div class="content">
                                    <a href="{{ route('provider.detail', $bookingData['provider_data']['id']) }}">
                                        <h5 class="mt-0 mb-1 text-capitalize">
                                            {{ $bookingData['provider_data']['display_name'] }}</h5>
                                    </a>
                                    <div class="d-flex align-items-center gap-1 flex-wrap">
                                        <div>
                                            <rating-component :readonly=true :showrating="false"
                                                :ratingvalue="{{ $bookingData['provider_data']['providers_service_rating'] }}" />
                                        </div>
                                        <a
                                            href="{{ route('rating.all', ['provider_id' => $bookingData['provider_data']['id']]) }}"><span
                                                class="h6 lh-1 align-middle">({{ round($bookingData['provider_data']['providers_service_rating'], 1) }})</span></a>
                                    </div>

                                    @if (
                                        $bookingData['booking_detail']['status'] == 'accept' ||
                                            $bookingData['booking_detail']['status'] == 'on_going' ||
                                            $bookingData['booking_detail']['status'] == 'in_progress' ||
                                            $bookingData['booking_detail']['status'] == 'hold')
                                        <ul class="list-inline mt-3 mb-0 p-0">
                                                        ...
                                                        <span class="text-body flex-shrink-0">
                                                            <svg width="18" height="18" viewBox="0 0 16 16"
                                                                ...
                                                                <mask style="mask-type:luminance"
                                                                    maskUnits="userSpaceOnUse" x="0" y="1" width="15"
                                                                    height="14">
                                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <span class="text-body flex-shrink-0">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                                height="17" viewBox="0 0 14 15" fill="none">
                                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        <span
                                                            class="h6 text-body">{{ $bookingData['provider_data']['address'] }}</span>
                                                    </div>
                                                </li>
                                            @endif
                                            @if (!empty($bookingData['provider_data']['contact_number']))
                                                <li>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <span class="text-body flex-shrink-0">
                                                            <svg width="18" height="18" viewBox="0 0 26 27"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <mask style="mask-type:luminance"
                                                                    maskUnits="userSpaceOnUse" x="15" y="2" width="10"
                                                                    height="10">
                                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        <span class="h6 text-body"><a
                                                                href="tel: {{ $bookingData['provider_data']['contact_number'] }}">{{ $bookingData['provider_data']['contact_number'] }}</a></span>
                                                    </div>
                                                </li>
                                            @endif
                                        </ul>
                                ...
                                <div class="col-lg-5 col-sm-6 mt-sm-0 mt-5">
                                    ...
                                    @foreach ($bookingData['handyman_data'] as $handyman)
                                        @if ($bookingData['provider_data']['id'] !== $handyman['id'])
                                            <h6 class="mt-0 mb-4 font-size-18 text-capitalize">
                                                {{ __('landingpage.about_handyman') }}</h6>
                                            <div class="img flex-shrink-0 mb-4">
                                                <a href="{{ route('handyman-detail', $handyman['id']) }}">
                                                    <img src="{{ $handyman['profile_image'] ? asset($handyman['profile_image']) : asset('images/user/user.png') }}"
                                            ...
                                            <div class="content">
                                                <a href="{{ route('handyman-detail', $handyman['id']) }}">
                                                    <h5 class="mt-0 mb-1 text-capitalize">{{ $handyman['display_name'] }}
                                                    </h5>
                                                </a>
                                                <div class="d-flex align-items-center gap-1 flex-wrap">
                                                    <div>
                                                        <rating-component :readonly=true :showrating="false"
                                                            :ratingvalue="{{ $handyman['handyman_rating'] }}" />
                                                    </div>
                                                    <a
                                                        href="{{ route('rating.all', ['handyman_id' => $handyman['id']]) }}">
                                                        <span
                                                            class="h6 lh-1">({{ round($handyman['handyman_rating'], 1) }})</span>
                                                    </a>
                                                </div>
                                                            ...
                                                            <li class="mb-1">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    ...
                                                                    <span class="h6 text-body">
                                                                        <a
                                                                            href="mailto:{{ $handyman['email'] }}">{{ $handyman['email'] }}</a>
                                                                    </span>
                                                                </div>
                                                            <li>
                                                        @endif
                                                                ...
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <span class="text-body flex-shrink-0">
                                                                        <svg width="18" height="18"
                                                                            ...
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <mask style="mask-type:luminance"
                                                                                maskUnits="userSpaceOnUse" x="15" y="2"
                                                                                width="10" height="10">
                                                                                <path fill-rule="evenodd"
                                                                                    clip-rule="evenodd"
                                                                                    d="M15.55 2.66699H24.8006V11.9109H15.55V2.66699Z"
                                                                    ...
                                                                    <span class="h6 text-body"><a
                                                                            href="tel: {{ $handyman['contact_number'] }}">{{ $handyman['contact_number'] }}</a></span>
                                                                </div>
                                                            </li>
                                                        @endif
                                                    </ul>
                                                ...
                                                @php
                                                    $handymanrating = App\Models\HandymanRating::where(
                                                        'booking_id',
                                                        $bookingData['booking_detail']['id'],
                                                    )
                    ...
                    @php
                        ...
                        if (
                            isset($bookingData['booking_detail']['BookingAddonService']) &&
                            is_array($bookingData['booking_detail']['BookingAddonService'])
                        ) {
                        ...
                        <div class="col-lg-6 col-md-5 mt-md-0 mt-5">
                            <div class="position-relative px-lg-3">
                                @if ($bookingData['booking_detail']['status'] == 'cancelled' && $bookingData['booking_detail']['refund_amount'])
                                    <h6 class="mt-0 mb-3 font-size-18 text-capitalize">
                                        {{ __('messages.refund_price_detail') }}</h6>
                                    <div class="table-responsive">
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                <tr>
                                                    <td class="py-2">
                                                        <h6 class="text-capitalize m-0">{{ __('messages.refund_of') }}
                                                            {{ getPriceFormat($bookingData['booking_detail']['refund_amount']) ?? 0 }}
                                                        </h6>
                                                    </td>
                                                    <td class="py-2">
                                                        <h6 class="text-end m-0 text-success">
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <h6 class="text-capitalize m-0">
                                                            {{ __('messages.payment_method') }}</h6>
                                                    </td>
                                                    <td class="py-2">
                                                        <h6 class="text-end m-0">
                                                ...
                                                <tr>
                                                    ...
                                                    @if (!empty($bookingData['bookingpackage']))
                                                        <td>
                                                            <span
                                                                class="d-block text-end">{{ getPriceFormat($bookingData['bookingpackage']['price']) }}</span>
                                                        </td>
                                                    @else
                                                        <td>
                                                            <span
                                                                class="d-block text-end">{{ getPriceFormat($bookingData['booking_detail']['amount']) }}</span>
                                                        </td>
                                                    @endif
                                                </tr>
                                                @if ($bookingData['service']['is_enable_advance_payment'] == 1)
                                                    <tr class="bg-light">
                                                        <td class="py-2">
                                                            <h6 class="text-capitalize m-0">
                                                                {{ __('landingpage.advance_payment') }}</h6>
                                                        </td>
                                                        <td class="py-2">
                                                            <h6 class="text-end m-0">
                                                ...
                                                <tr class="bg-light">
                                                    <td class="py-2">
                                                        <h6 class="text-capitalize m-0">
                                                            {{ __('messages.cancellation_charge') }}</h6>
                                                    </td>
                                                    <td class="py-2">
                                                        <h6 class="text-end m-0">
                                ...
                                <h6 class="mt-5 mb-3 font-size-18 text-capitalize">{{ __('landingpage.price_detail') }}
                                </h6>
                                <div class="table-responsive">
                                    <table class="table table-borderless mb-0">
                                        <tbody>
                                            ...
                                            @if (!empty($bookingData['booking_detail']['final_discount_amount']))
                                                <tr>
                                                    <td>
                                                        <span class="text-capitalize">{{ __('messages.discount') }} <span
                                                                class="text-success">({{ $bookingData['booking_detail']['discount'] }}%
                                                                {{ __('landingpage.off') }})</span></span>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="d-block text-end text-success">-{{ getPriceFormat($bookingData['booking_detail']['final_discount_amount']) }}</span>
                                                        {{-- <span class="d-block text-end text-success">-{{ getPriceFormat($bookingData['booking_detail']['discount']/100) }}</span>  --}}
                                                    </td>
                                                </tr>
                                            @endif
                                            @if (
                                                $bookingData['coupon_data'] &&
                                                    $bookingData['booking_detail']['final_coupon_discount_amount'] < $bookingData['booking_detail']['total_amount']
                                            )
                                                <tr>
                                                    <td>
                                                        <span class="text-capitalize">{{ __('landingpage.coupon') }}
                                                            <span class="text-primary">
                                                                ({{ $bookingData['coupon_data']['code'] }})</span>
                                                        </span>
                                                    </td>
                                                    <td>
                                            ...
                                            @if (!empty($bookingData['booking_detail']['BookingAddonService']))
                                                <tr>
                                                    <td>
                                                        <span
                                                            class="text-capitalize">{{ __('landingpage.Add-ons') }}</span>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="d-block text-primary text-end">{{ getPriceFormat($addonAmount) }}</span>
                                                    </td>
                                                </tr>
                                            @endif
                                            ...
                                            @if (!empty($bookingData['booking_detail']['extra_charges_value']))
                                                <tr>
                                                    <td>
                                                        <span
                                                            class="text-capitalize">{{ __('landingpage.total_extra_charges') }}</span>
                                                    </td>
                                                    <td>
                                                        <span
                                            ...
                                            @php
                                                $totalamount =
                                                    $bookingData['booking_detail']['post_request_id'] == null
                                                        ? getPriceFormat(
                                                            $bookingData['booking_detail']['final_sub_total'],
                                                        )
                                                        : getPriceFormat(
                                                            $bookingData['booking_detail']['total_amount'],
                                                        );
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($bookingData['booking_detail']['final_total_tax'] > 0)
                                                            <span class=" d-block text-end text-danger"><i type="button"
                                                                    class="fa fa-info-circle text-body" aria-hidden="true"
                                                                    data-bs-toggle="modal" data-bs-target="#taxModal"></i>
                                                                +{{ getPriceFormat($bookingData['booking_detail']['final_total_tax']) }}</span>
                                                        @else
                                                            <span
                                                                class=" d-block text-end text-danger">+{{ getPriceFormat($bookingData['booking_detail']['final_total_tax']) }}</span>
                                                        @endif
                                                </tr>
                                            @endif
                                            <tr class="bg-light">
                                                    ...
                                                    <tr>
                                                        <td>{{ __('messages.remaining_amount') }}
                                                            @if ($bookingData['booking_detail'] != null && $bookingData['booking_detail']['payment_status'] !== 'paid')
                                                                <span
                                                                    class="badge bg-warning">{{ __('messages.pending') }}</span>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td class="text-end">
                                                            @if ($bookingData['booking_detail'] != null && $bookingData['booking_detail']['payment_status'] == 'paid')
                                                                <span
                                                                    class="badge bg-success">{{ __('messages.paid') }}</span>
                                                            @else
    ...
    @endif -->
                            ...
                            <div class="px-lg-3 mt-5">
                                @if (count($bookingData['booking_detail']['extra_charges']) > 0)
                                    <h6 class="mt-0 mb-3 font-size-18 text-capitalize">
                                        {{ __('landingpage.extra_charges') }}</h6>
                                    <div class="table-responsive">
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pd-0">
                                                            <h6 class="text-end"><span
                                                                    class="font-size-14 text-body">{{ getPriceFormat($charge['price']) }}*{{ $charge['qty'] }}
                                                                    =</span>
                                                                {{ getPriceFormat($charge['price'] * $charge['qty']) }}
                                                            </h6>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                ...
                                @if (!empty($bookingData['booking_detail']['payment_id']))
                                    <h6 class="mt-5 mb-3 font-size-18 text-capitalize">
                                        {{ __('landingpage.payment_detail') }}</h6>
                                    <div class="table-responsive">
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="pd-0">
                                                        <span
                                                            class="d-block text-end">#{{ $bookingData['booking_detail']['payment_id'] }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-0">
                                                    ...
                                                    <td class="pd-0">
                                                        <span
                                                            class="d-block text-end text-capitalize">{{ $bookingData['booking_detail']['payment_method'] }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-0">
                                                    ...
                                                    <td class="pd-0">
                                                        <span
                                                            class="d-block text-end text-capitalize">{{ str_replace('_', ' ', $bookingData['booking_detail']['payment_status']) }}</span>
                                                    </td>
                                                </tr>
                                                @if ($bookingData['booking_detail']['txn_id'])
                                                    <tr>
                                                        <td class="ps-0">
                                                            <span
                                                                class="text-capitalize">{{ __('landingpage.transaction_id') }}</span>
                                                        </td>
                                                        <td class="pd-0">
                                                            <span
                                                                class="d-block text-end">{{ $bookingData['booking_detail']['txn_id'] }}</span>
                                                        </td>
                                                    </tr>
                                                @endif
                                            </tbody>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-sm-5">
                    <div class="text-center">
                        @if (
                            $bookingData['booking_detail']['payment_id'] !== null &&
                                $bookingData['booking_detail']['payment_status'] == 'paid' &&
                                $bookingData['booking_detail']['status'] == 'completed')
                            <a href="{{ route('invoice_pdf', $bookingData['booking_detail']['id']) }}"
                    ...
                    <div class="text-center">
                        @if (
                            ...
                            <a onclick="togglePayment()" id="pay_advance" class="btn btn-primary text-capitalize w-100"
                                style="display: block;">{{ __('landingpage.pay_advance') }}</a>
                        @endif

                        @if (
                            $bookingData['service']['visit_type'] == 'ONLINE' &&
                                $bookingData['booking_detail']['status'] == 'completed' &&
                                ($bookingData['booking_detail']['payment_id'] == null ||
                                    $bookingData['booking_detail']['payment_status'] == 'failed' ||
                                    $bookingData['booking_detail']['payment_status'] == 'pending'))
                            ...
                            <a onclick="togglePayment()" id="pay_advance" class="btn btn-primary text-capitalize w-100"
                                style="display: block;">{{ __('landingpage.pay_now') }}</a>
                        @endif
                    </div>
                </div>
                <div class="col-lg-4 d-lg-block d-none"></div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    @php
                        $bookingRating = App\Models\BookingRating::where(
                            'booking_id',
                            $bookingData['booking_detail']['id'],
                        )
                            ->where('customer_id', auth()->user()->id)
                        ...
                        if (!empty($bookingRating)) {
                            ...
                            $bookingRating->profile_image = getSingleMedia(
                                $bookingRating->customer,
                                'profile_image',
                                null,
                            );
                            $bookingRating->date = date(
                                $date_time['date_format'],
                                strtotime($bookingRating->created_at),
                            );
                        }
                    @endphp
                    @if ($bookingData['booking_detail']['status'] == 'completed')
                        <booking-rating :booking_id="{{ $bookingData['booking_detail']['id'] }}"
                            :service_id="{{ $bookingData['service']['id'] }}" :customer_id="{{ auth()->user()->id }}"
                            :bookingrating="{{ json_encode($bookingRating) }}"></booking-rating>
                    @endif

                    @if (count($bookingData['rating_data']) !== 0)
                        <div class="pt-lg-5 pt-3 mt-lg-5 mt-3">
                            <div class="mt-3">
                                <h5 class="mb-5">{{ count($bookingData['rating_data']) }}
                                    {{ __('landingpage.review_for') }}
                                    {{ $bookingData['booking_detail']['service_name'] }}</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ratingModalLabel">{{ __('landingpage.your_review') }}
                    </h5>
                        ...
                        @foreach ($bookingData['booking_detail']['taxes'] as $tax)
                            <div class="d-flex justify-content-between">
                                ...
                                @if ($tax['type'] == 'percent')
                                    ...
                                    <p>{{ getPriceFormat(($tax['value'] * $bookingData['booking_detail']['final_sub_total']) / 100) }}
                                    </p>
                                @else
                                    <p>{{ $tax['title'] }} </p>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content overflow-visible">
                <div class="modal-header border-bottom-0 gap-2">
                    <h5 class="modal-title text-capitalize" id="statusModalLabel">
                        {{ __('landingpage.booking_history') }}</h5>
                    <span class="text-primary custom-btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41"
                            fill="none">
                            <rect x="12" y="11.8381" width="17" height="17" fill="white"></rect>
                            ...
                            <li class="done">
                                <div class="status-timeline-wrapper position-relative">
                                    <div class="timeline-time-block text-md-end">
                                        <h6 class="text-uppercase m-0 time">
                                            {{ date($date_time['time_format'], strtotime($time)) }}</h6>
                                        <p class="text-capitalize m-0 date">
                                            {{ date($date_time['date_format'], strtotime($date)) }}</p>
                                    </div>
                                    <div class="timeline-content-block text-md-start">
                                        <h6 class="text-capitalize m-0 title">{{ $bookingactivity['activity_type'] }}
                                        </h6>
                                        <p class="text-capitalize m-0 description">
                                            {{ $bookingactivity['activity_message'] }}</p>
                                    </div>
    ...
    <div class="modal fade" id="reasonModal" aria-labelledby="reasonModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title text-capitalize fw-bold" id="ratingModalLabel">
                        {{ __('landingpage.reason_modal_msg') }}</h6>
                    <span class="text-primary custom-btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41"
                            fill="none">
                            <rect x="12" y="11.8381" width="17" height="17" fill="white"></rect>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-4">
                            <button type="button" onclick="holdBooking()"
    ...
    <div class="modal fade" id="cancelModal" aria-labelledby="reasonModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title text-capitalize fw-bold" id="ratingModalLabel">
                        {{ __('landingpage.cancel_modal_msg') }}</h6>
                    <span class="text-primary custom-btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41"
                            fill="none">
                            <rect x="12" y="11.8381" width="17" height="17" fill="white"></rect>
                ...
                <div class="modal-body">
                    <form>
                        @if ($bookingData['booking_detail']['cancellation_charge_amount'] > 0)
                            <div class="mb-4">
                                <label class="form-label text-capitalize">{{ __('landingpage.total_cancellation_fee') }}:
                                    <span>{{ getPriceFormat($bookingData['booking_detail']['cancellation_charge_amount']) }}</span>(<span>{{ $bookingData['booking_detail']['cancellationcharges'] }}%</span>)</label>
                                <p>{{ __('landingpage.based_book_service') }}</p>
                            </div>
                            <input type="hidden" id="cancellation_charge"
                                value="{{ $bookingData['booking_detail']['cancellationcharges'] }}">
                            <input type="hidden" id="cancellation_charge_amount"
                                value="{{ $bookingData['booking_detail']['cancellation_charge_amount'] }}">
                        @endif
                        <div class="mb-4">
                            <label class="form-label text-capitalize">{{ __('landingpage.reason') }}</label>
...
@section('after_script')
    <script>
        ...
        let IsLoading = false;
        const updateBookingStatus = (status, start_at = '', end_at = '', duration_diff = 0, reason = '',
            cancellation_charge = 0, cancellation_charge_amount = 0, payment_status = '') => {
        ...
        function cancelBooking() {
            ...
            end_at = "";
            duration_diff = "";
            reason = document.getElementById('cancel_reason') ? document.getElementById('cancel_reason').value :
                ''; // Check if element exists
            cancellation_charge = document.getElementById('cancellation_charge') ? document.getElementById(
                'cancellation_charge').value : 0; // Check if element exists
            cancellation_charge_amount = document.getElementById('cancellation_charge_amount') ? document.getElementById(
                'cancellation_charge_amount').value : 0; // Check if element exists
            updateBookingStatus(status, start_at, end_at, duration_diff, reason, cancellation_charge,
        ...
        function doneBooking() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    duration_diff = parseInt(duration) + Math.floor((new Date(end_at) - new Date(start_at)) / (
                        1000 * 60));
                    reason = "Done";
                    updateBookingStatus(status, start_at, end_at, duration_diff, reason);
                }
